var container = document.getElementById('slider-container-aboutus');
var slider = document.getElementById('slider-aboutus');
var slides = document.querySelectorAll('.slide');
var buttons = {
    left: document.getElementById('slider-btn-left-aboutus'),
    right: document.getElementById('slider-btn-right-aboutus')
};
